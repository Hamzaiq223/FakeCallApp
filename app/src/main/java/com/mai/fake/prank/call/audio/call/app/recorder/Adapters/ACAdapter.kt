...
class ACAdapter(private val context: Context, private val itemList: List<CharactersModel>, private val click: ClickListener) :
    ...
    interface ClickListener {
        fun onClick(charactersModel: CharactersModel)
    }
}
