...
class VCAdapter(private val context: Context, private val itemList: List<CharactersModel>, private val click: ClickListener) :
    RecyclerView.Adapter<VCAdapter.ViewHolder>() {
